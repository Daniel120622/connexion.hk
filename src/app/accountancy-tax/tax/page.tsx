...
export default function TaxConsultingPage() {
  ...
  const content = {
    en: {
      ...
      heroDesc: "Strategic tax planning, profits tax compliance, and dispute resolution for Hong Kong and global businesses.",
    ...
    zh: {
      heroTitle: "稅務服務",
      heroDesc: "稅務規劃、利得稅合規、以香港為基礎的跨境稅務架構，以及香港企業的稅務爭議解決",
    ...
    cn: {
      heroTitle: "税务服务",
      heroDesc: "税务规划、利得税合规、以香港为基础的跨境税务架构，以及香港企业的税务争议解决",
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <ServiceHero
        ...
        imageAlt="Tax consulting background"
        ctaLabel={current.ctaButton}
        ctaHref="/contact"
        index={accountancyServicesOrder.indexOf("tax") + 1}

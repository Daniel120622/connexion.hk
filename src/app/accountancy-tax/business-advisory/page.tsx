...
export default function BusinessAdvisoryPage() {
  ...
  const t = useTranslations("Pages.BusinessAdv");
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <ServiceHero
        ...
        imageSrc="/images/services/businessAdv.jpg"
        imageAlt="Business advisory background"
        ctaLabel={t("ctaButton")}
        ctaHref="/contact"
        index={accountancyServicesOrder.indexOf("business-advisory") + 1}
